...
<head>
    <title>Code coverage report for stubTransport.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> stubTransport.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >          contents.push(chunk.content)</span>
        }
        let info = {
          messageId,
          response,
