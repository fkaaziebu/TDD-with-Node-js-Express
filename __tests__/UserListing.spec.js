...
describe("Listing Users", () => {
  ...
  it("returns to 2 as total pages when there are 15 active and 7 inactive users", async () => {
    await addUsers(15, 7);
    const response = await getUsers();
  ...
  it("returns 5 users and corresponding indicator when size is set as 5 parameter", async () => {
    await addUsers(11);
  ...
  it("returns 10 users and corresponging size indicator when size is set as 1000", async () => {
    await addUsers(11);
